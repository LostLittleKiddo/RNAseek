...
| Frontend validation hardening           | Done   | All 10 rules mirrored in `pipeline_setup.js` with toast notifications (Steps 2, 3, 4, pre-submission)                                         |
