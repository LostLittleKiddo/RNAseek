...
| `models.py`             | 184   | 4 Django models: `Session` (UUID PK, 14-day TTL), `AnalysisSubmission` (input/assay config, metadata JSON), `FileAsset` (15 file roles), `AnalysisJob` (Celery task state, `result_payload` JSON, `step_progress` JSON). `ModuleResult` removed in migration 0010. |
...
| `context_processors.py` | 6     | Injects `session_id` and `is_production` into template context                                                                                                                                                                                                |
| `admin.py`              | 1     | Empty (no admin registrations)                                                                                                                                                                                                                                     |
| `apps.py`               | 6     | Django `AppConfig` for `pipeline`                                                                                                                                                                                                                                  |
| `urls.py`               | —     | 6 page routes + 12 API routes. No `/advanced/` route (removed).                                                                                                                                                                                                     |
...
| File          | Lines | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `__init__.py` | 22    | Re-exports all view classes from `pages.py`, `api.py`, and `tus_webhook.py`                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `tus_webhook.py` | ~180 | 2 views: `TusWebhookView` (tusd post-finish webhook with HMAC verification, file move, FileAsset creation, tusd v2 body-based Type field support), `TusAssetLookupView` (GET: resolves Tus upload filename to FileAsset ID for frontend asset management) |
