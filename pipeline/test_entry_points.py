...
class CorePipelineViewValidationTest(TestCase):
    ...
    def test_alignment_custom_genome_only_needs_gtf(self):
    ...
    def test_matrix_no_genome_required(self):
    ...
    def test_matrix_no_library_type_required(self):
    ...
    @patch("pipeline.views.run_core_pipeline")
...
class TaskRouterTest(TestCase):
    ...
    def test_resolve_genome_preindexed(self):
        ...
        self.assertIn("r64", idx)
        self.assertIn("r64", fasta)
